...
public class InterfazEspana implements InterfazPais {
    private Catalogo catalogo;
    private ClienteTiendaProxy cliente;
    private Compra compra;
    private Sucursal sucursalEspana;
    private AlmacenCheemsMart almacenCheemsMart;


    public InterfazEspana(Catalogo catalogo, ClienteTiendaProxy cliente,
                          Compra compra, Sucursal sucursalEspana, AlmacenCheemsMart almacenCheemsMart) {
        this.catalogo = catalogo;
        this.cliente = cliente;
        this.compra = compra;
        this.sucursalEspana = sucursalEspana;
    ...
    public void realizarCompra() {
        ...
        while (!salir) {
            ...
            switch (opcion) {
                case 1:
                    catalogo.mostrarSeccionDepto("Belleza");
                    System.out.println("Añadir a la cesta");
                ...
                case 9:
                    if (compra.esVaciaLaCompra()) {
                        System.out.println("No has añadido nada a la cesta ...");
                        salir = false;
                    } else {
                        pagarCompra();
                        salir = true;
    ...
    public void pagarCompra() {
        ...
        double totalAPagar = sucursalEspana.cobrar(compra.getCarritoDeCompra());
    ...
    public String mensajeDeDescuento(double descuento) {
        return "Tienes un descuento de " + descuento + "% en electrodomésticos!!";
    }
